  ...
  return (
    <div className="w-full py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12 font-lato">
          <span className="text-sm uppercase tracking-wider text-teal-800 font-semibold font-lato">
            SERVICES
          </span>
          <h2 className="text-4xl font-bold text-teal-900 mt-2 font-lato">
            Your Path to
            <br />
            Well-being
          </h2>
          <p className="text-teal-900/70 mt-4 font-lato">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-orange-100 border border-orange-200 rounded-[30px] p-8 relative overflow-hidden flex flex-col min-h-[320px] font-lato">
            <div className="z-10 relative">
              <h3 className="text-2xl font-semibold text-teal-900 font-lato">
                Mindfulness &<br />
                Meditation
              </h3>
              <p className="mt-4 text-teal-900/80 font-lato">
              ...
              <button className="mt-6 px-6 py-2 border border-teal-800 text-teal-800 rounded-[30px] hover:bg-teal-800 hover:text-white transition-colors font-lato">
                Learn More
              </button>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-[30px] p-8 relative overflow-hidden flex flex-col min-h-[320px] font-lato">
            <div className="z-10 relative">
              <h3 className="text-2xl font-semibold text-teal-900 font-lato">
                One-on-One
                <br />
        ...
        <div className="mt-8">
          <div className="bg-white border border-gray-200 rounded-[30px] p-8 relative overflow-hidden grid grid-cols-1 md:grid-cols-2 items-center font-lato">
            <div className="z-10 relative">
              <h3 className="text-2xl font-semibold text-teal-900 font-lato">
                Wellness Coaching
              </h3>
              ...
              <button className="mt-6 px-6 py-2 bg-teal-800 text-white rounded-[30px] hover:bg-teal-700 transition-colors font-lato">
                Learn More
              </button>
            </div>
